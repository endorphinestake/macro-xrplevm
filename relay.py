...
def patched_hashlib_new(name, data=b""):
    if name.lower() == "ripemd160":
        ...
        h.update(data)
        return h
    return hashlib.__old_new(name, data)


# Ubuntu Patch (fix 'unsupported hash type ripemd160')
hashlib.__old_new = hashlib.new
hashlib.new = patched_hashlib_new

# ——— BandChain config ———
BAND_MNEMONIC = os.getenv("MNEMONIC")
OS_ID = 14
...
# ——— EVM config ———
EVM_RPC_URL = "https://xrpl-evm.endorphinestake.com"
